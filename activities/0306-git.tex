...
\begin{exercise}
  ...
  \begin{enumerate}
    ...
    \item Open a pull request. Write a message to the course staff if
      you want. Be careful: you will not be given full points if you
      do not open a pull request even though you have successfully
